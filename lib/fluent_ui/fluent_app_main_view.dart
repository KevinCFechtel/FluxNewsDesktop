...
class FluentCategorieNavigationMainView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String? datePattern = "";
    if (Platform.isMacOS) {
      datePattern = SystemDateTimeFormat.of(context).mediumDatePattern;
    } else if (Platform.isWindows) {
      datePattern = SystemDateTimeFormat.of(context).datePattern;
    }
    final timePattern = SystemDateTimeFormat.of(context).timePattern;
    final dateFormatString = '$datePattern $timePattern';
                      ...
                      for (Feed feed in category.feeds) {
                        ...
                        feedItems.add(PaneItem(
                          ...
                          trailing: appState.truncateMode == 2
                              ? ToggleButton(
                                  checked: feed.manualTruncate != null
                                      ? feed.manualTruncate!
                                      : false,
    ...
    return CommandBar(
      ...
      secondaryItems: [
        ...
        CommandBarButton(
          ...
          label: appState.selectedCategoryElementType ==
